...
module Esi
  class LoyaltyApi
    ...
    def get_loyalty_points_with_http_info(character_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'character_id' when calling LoyaltyApi.get_loyalty_points" if character_id.nil?
    ...
    def get_loyalty_store_by_id_with_http_info(corporation_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'corporation_id' when calling LoyaltyApi.get_loyalty_store_by_id" if corporation_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
