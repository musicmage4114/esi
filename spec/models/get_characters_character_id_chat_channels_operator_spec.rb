...
# Unit tests for SwaggerClient::GetCharactersCharacterIdChatChannelsOperator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsOperator' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCharactersCharacterIdChatChannelsOperator.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsOperator' do
    it 'should create an instact of GetCharactersCharacterIdChatChannelsOperator' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCharactersCharacterIdChatChannelsOperator)
    end
  end
