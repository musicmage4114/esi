...
# Unit tests for SwaggerClient::ChatChannelOperator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChatChannelOperator' do
  before do
    # run before each test
    @instance = SwaggerClient::ChatChannelOperator.new
  end
  ...
  describe 'test an instance of ChatChannelOperator' do
    it 'should create an instact of ChatChannelOperator' do
      expect(@instance).to be_instance_of(SwaggerClient::ChatChannelOperator)
    end
  end
