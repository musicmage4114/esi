...
# Unit tests for SwaggerClient::NextVulnerability
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NextVulnerability' do
  before do
    # run before each test
    @instance = SwaggerClient::NextVulnerability.new
  end
  ...
  describe 'test an instance of NextVulnerability' do
    it 'should create an instact of NextVulnerability' do
      expect(@instance).to be_instance_of(SwaggerClient::NextVulnerability)
    end
  end
