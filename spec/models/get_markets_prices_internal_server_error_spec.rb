...
# Unit tests for Esi::GetMarketPricesInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMarketPricesInternalServerError' do
  before do
    # run before each test
    @instance = Esi::GetMarketPricesInternalServerError.new
  end
  ...
  describe 'test an instance of GetMarketPricesInternalServerError' do
    it 'should create an instact of GetMarketPricesInternalServerError' do
      expect(@instance).to be_instance_of(Esi::GetMarketPricesInternalServerError)
    end
  end
