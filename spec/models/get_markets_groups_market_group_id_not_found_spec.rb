...
# Unit tests for Esi::GetMarketGroupByIdNotFound
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMarketGroupByIdNotFound' do
  before do
    # run before each test
    @instance = Esi::GetMarketGroupByIdNotFound.new
  end
  ...
  describe 'test an instance of GetMarketGroupByIdNotFound' do
    it 'should create an instact of GetMarketGroupByIdNotFound' do
      expect(@instance).to be_instance_of(Esi::GetMarketGroupByIdNotFound)
    end
  end
