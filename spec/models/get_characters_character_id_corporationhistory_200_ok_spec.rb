...
# Unit tests for SwaggerClient::PastCorporation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PastCorporation' do
  before do
    # run before each test
    @instance = SwaggerClient::PastCorporation.new
  end
  ...
  describe 'test an instance of PastCorporation' do
    it 'should create an instact of PastCorporation' do
      expect(@instance).to be_instance_of(SwaggerClient::PastCorporation)
    end
  end
