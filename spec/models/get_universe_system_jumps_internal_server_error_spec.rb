...
# Unit tests for Esi::GetSystemJumpsInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSystemJumpsInternalServerError' do
  before do
    # run before each test
    @instance = Esi::GetSystemJumpsInternalServerError.new
  end
  ...
  describe 'test an instance of GetSystemJumpsInternalServerError' do
    it 'should create an instact of GetSystemJumpsInternalServerError' do
      expect(@instance).to be_instance_of(Esi::GetSystemJumpsInternalServerError)
    end
  end
