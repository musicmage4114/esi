...
# Unit tests for SwaggerClient::ViewableMarketOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ViewableMarketOrder' do
  before do
    # run before each test
    @instance = SwaggerClient::ViewableMarketOrder.new
  end
  ...
  describe 'test an instance of ViewableMarketOrder' do
    it 'should create an instact of ViewableMarketOrder' do
      expect(@instance).to be_instance_of(SwaggerClient::ViewableMarketOrder)
    end
  end
