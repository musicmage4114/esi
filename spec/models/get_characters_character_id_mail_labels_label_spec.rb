...
# Unit tests for SwaggerClient::MailLabelInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailLabelInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::MailLabelInfo.new
  end
  ...
  describe 'test an instance of MailLabelInfo' do
    it 'should create an instact of MailLabelInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::MailLabelInfo)
    end
  end
