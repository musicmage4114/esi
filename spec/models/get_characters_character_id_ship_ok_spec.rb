...
# Unit tests for SwaggerClient::CurrentShip
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CurrentShip' do
  before do
    # run before each test
    @instance = SwaggerClient::CurrentShip.new
  end
  ...
  describe 'test an instance of CurrentShip' do
    it 'should create an instact of CurrentShip' do
      expect(@instance).to be_instance_of(SwaggerClient::CurrentShip)
    end
  end
