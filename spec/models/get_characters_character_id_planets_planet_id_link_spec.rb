...
# Unit tests for SwaggerClient::ColonyLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ColonyLink' do
  before do
    # run before each test
    @instance = SwaggerClient::ColonyLink.new
  end
  ...
  describe 'test an instance of ColonyLink' do
    it 'should create an instact of ColonyLink' do
      expect(@instance).to be_instance_of(SwaggerClient::ColonyLink)
    end
  end
