...
# Unit tests for Esi::GetDogmaEffectsInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDogmaEffectsInternalServerError' do
  before do
    # run before each test
    @instance = Esi::GetDogmaEffectsInternalServerError.new
  end
  ...
  describe 'test an instance of GetDogmaEffectsInternalServerError' do
    it 'should create an instact of GetDogmaEffectsInternalServerError' do
      expect(@instance).to be_instance_of(Esi::GetDogmaEffectsInternalServerError)
    end
  end
