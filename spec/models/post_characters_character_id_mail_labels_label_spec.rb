...
# Unit tests for SwaggerClient::NewMailLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewMailLabel' do
  before do
    # run before each test
    @instance = SwaggerClient::NewMailLabel.new
  end
  ...
  describe 'test an instance of NewMailLabel' do
    it 'should create an instact of NewMailLabel' do
      expect(@instance).to be_instance_of(SwaggerClient::NewMailLabel)
    end
  end
