...
# Unit tests for SwaggerClient::FleetMember
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FleetMember' do
  before do
    # run before each test
    @instance = SwaggerClient::FleetMember.new
  end
  ...
  describe 'test an instance of FleetMember' do
    it 'should create an instact of FleetMember' do
      expect(@instance).to be_instance_of(SwaggerClient::FleetMember)
    end
  end
