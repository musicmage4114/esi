...
# Unit tests for SwaggerClient::IndustryCostIndex
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IndustryCostIndex' do
  before do
    # run before each test
    @instance = SwaggerClient::IndustryCostIndex.new
  end
  ...
  describe 'test an instance of IndustryCostIndex' do
    it 'should create an instact of IndustryCostIndex' do
      expect(@instance).to be_instance_of(SwaggerClient::IndustryCostIndex)
    end
  end
