...
# Unit tests for SwaggerClient::JumpClone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JumpClone' do
  before do
    # run before each test
    @instance = SwaggerClient::JumpClone.new
  end
  ...
  describe 'test an instance of JumpClone' do
    it 'should create an instact of JumpClone' do
      expect(@instance).to be_instance_of(SwaggerClient::JumpClone)
    end
  end
