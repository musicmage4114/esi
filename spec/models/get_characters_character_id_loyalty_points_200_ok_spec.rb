...
# Unit tests for SwaggerClient::LoyaltyPointsAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoyaltyPointsAmount' do
  before do
    # run before each test
    @instance = SwaggerClient::LoyaltyPointsAmount.new
  end
  ...
  describe 'test an instance of LoyaltyPointsAmount' do
    it 'should create an instact of LoyaltyPointsAmount' do
      expect(@instance).to be_instance_of(SwaggerClient::LoyaltyPointsAmount)
    end
  end
