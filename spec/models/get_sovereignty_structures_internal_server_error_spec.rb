...
# Unit tests for Esi::GetSovereigntyStructuresInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSovereigntyStructuresInternalServerError' do
  before do
    # run before each test
    @instance = Esi::GetSovereigntyStructuresInternalServerError.new
  end
  ...
  describe 'test an instance of GetSovereigntyStructuresInternalServerError' do
    it 'should create an instact of GetSovereigntyStructuresInternalServerError' do
      expect(@instance).to be_instance_of(Esi::GetSovereigntyStructuresInternalServerError)
    end
  end
