...
# Unit tests for SwaggerClient::BookmarkLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BookmarkLocation' do
  before do
    # run before each test
    @instance = SwaggerClient::BookmarkLocation.new
  end
  ...
  describe 'test an instance of BookmarkLocation' do
    it 'should create an instact of BookmarkLocation' do
      expect(@instance).to be_instance_of(SwaggerClient::BookmarkLocation)
    end
  end
