...
# Unit tests for SwaggerClient::CompletedOpportunity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompletedOpportunity' do
  before do
    # run before each test
    @instance = SwaggerClient::CompletedOpportunity.new
  end
  ...
  describe 'test an instance of CompletedOpportunity' do
    it 'should create an instact of CompletedOpportunity' do
      expect(@instance).to be_instance_of(SwaggerClient::CompletedOpportunity)
    end
  end
