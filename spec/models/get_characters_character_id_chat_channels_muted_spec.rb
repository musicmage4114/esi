...
# Unit tests for SwaggerClient::GetCharactersCharacterIdChatChannelsMuted
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsMuted' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCharactersCharacterIdChatChannelsMuted.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsMuted' do
    it 'should create an instact of GetCharactersCharacterIdChatChannelsMuted' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCharactersCharacterIdChatChannelsMuted)
    end
  end
